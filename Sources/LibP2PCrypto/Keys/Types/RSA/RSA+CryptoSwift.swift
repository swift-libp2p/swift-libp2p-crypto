...
struct RSAPrivateKey:CommonPrivateKey {
    ...
    var rawRepresentation: Data {
        guard key.d != nil else { /*throw NSError(domain: "Not a valid private RSA Key", code: 0)*/ return Data() }
        return try! self.key.externalRepresentation()
    }
...
extension CryptoSwift.RSA {
    ...
    fileprivate static func sign(message:Data, withKey key:RSA) throws -> Data {
        ...
        return try Data(key.sign(message.bytes, variant: .message_pkcs1v15_SHA256))
...
//        return signedData_RsaKey
    ...
    fileprivate static func verify(signature:Data, fromMessage message:Data, usingKey key:RSA) throws -> Bool {
        ...
        return try key.verify(signature: signature.bytes, for: message.bytes, variant: .message_pkcs1v15_SHA256)
